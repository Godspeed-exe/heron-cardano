...
Revision ID: 4df5bb9ac58b
Revises: 
Create Date: 2025-06-21 12:35:51.854549
...
def upgrade():
    ...
    op.execute(sa.text("CREATE SEQUENCE transaction_numeric_id_seq START 1"))
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('numeric_id', sa.Integer(), sa.Sequence('transaction_numeric_id_seq'), nullable=False, unique=True),
